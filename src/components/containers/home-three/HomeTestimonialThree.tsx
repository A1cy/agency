                      ...
                      <div className="col-12 col-lg-7 offset-lg-1 col-xxl-7 offset-xxl-1">
                        <div className="testimonial-s__content">
                          ...
                          <div className="content">
                            <h4>
                              "Alya Najd has completely transformed our digital
                              presence. Their strategic approach and innovative
                              solutions have significantly boosted our online
                              engagement."
                            </h4>
                          </div>
                          <div className="content-cta">
                            <h5>Mohammed Al-Rashid</h5>
                            <p>CEO, Saudi Tech Solutions</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="row gaper align-items-center">
                      ...
                      <div className="col-12 col-lg-7 offset-lg-1 col-xxl-7 offset-xxl-1">
                        <div className="testimonial-s__content">
                          ...
                          <div className="content">
                            <h4>
                              "Their expertise in web development has been a
                              game-changer for our business. The team at Alya
                              Najd delivers on time and exceeds expectations."
                            </h4>
                          </div>
                          <div className="content-cta">
                            <h5>Susan Lee</h5>
                    ...
                    <div className="row gaper align-items-center">
                      ...
                      <div className="col-12 col-lg-7 offset-lg-1 col-xxl-7 offset-xxl-1">
                        <div className="testimonial-s__content">
                          ...
                          <div className="content">
                            <h4>
                              "Working with Alya Najd has been a pleasure. Their
                              digital marketing strategies have driven
                              impressive results for our campaigns."
                            </h4>
                          </div>
                          <div className="content-cta">
                            <h5>Khalid Al-Mutairi</h5>
                            <p>COO, Riyadh Innovations</p>
                          </div>
                        </div>
                      </div>
                    </div>
